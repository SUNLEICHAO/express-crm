...
exports.seed = async function (knex) {
  ...
  await knex('customers').insert([
    ...
    { id: 5, name: '顾客E', phone: '15232000005', source: 'douyin', status: '1', },
    { id: 6, name: '顾客F', phone: '15232000006', source: 'douyin', status: '1', },
    { id: 7, name: '顾客G', phone: '15232000007', source: 'meituan', status: '1', },
    { id: 8, name: '顾客H', phone: '15232000008', source: 'douyin', status: '1', },
    { id: 9, name: '顾客I', phone: '15232000009', source: 'meituan', status: '1', },
    { id: 10, name: '顾客J', phone: '15232000010', source: 'douyin', status: '1', },
    { id: 11, name: '顾客K', phone: '15232000011', source: 'meituan', status: '1', },
    { id: 12, name: '顾客L', phone: '15232000012', source: 'douyin', status: '1', },
    { id: 13, name: '顾客M', phone: '15232000013', source: 'meituan', status: '1', },
    { id: 14, name: '顾客N', phone: '15232000014', source: 'meituan', status: '1', },
    { id: 15, name: '顾客O', phone: '15232000015', source: 'douyin', status: '1', },
    { id: 16, name: '顾客P', phone: '15232000016', source: 'meituan', status: '1', },
  ]);
