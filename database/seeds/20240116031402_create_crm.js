...
exports.seed = async function (knex) {
  ...
  await knex('customers').insert([
    { id: 1, name: '顾客A', phone: '13231018987', source: '1234', status: '1', },
    { id: 2, name: '顾客B', phone: '15231018287', source: '1234', status: '2', },
    { id: 3, name: '顾客C', phone: '13231218987', source: '1234', status: '1', },
    { id: 4, name: '顾客D', phone: '13231012987', source: '1234', status: '1', },
  ]);
  ...
  await knex('services').insert([
    { id: 1, userid: "2", customerid: '1' },
    { id: 2, userid: "1", customerid: '2' },
    { id: 3, userid: "1", customerid: '3' },
  ]);
};
